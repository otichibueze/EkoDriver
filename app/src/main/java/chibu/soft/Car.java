...
public class Car {
     ...
     //public Color color;
      ...
      public Car(int type,float speed,float x, float y,boolean crashed)
      {
          this.type = type;
          //this.color = color;
          this.speed = speed;
      ...
      public static final int AudiA2 = 0,AudiA6 = 1,AudiR8 = 2,AudiS5 = 3, BmwX6 = 4 ,Camaro = 5,Crossfire = 6,
